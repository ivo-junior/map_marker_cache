...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 6033270575689046165),
    name: 'CachedIcon',
    lastPropertyId: const obx_int.IdUid(3, 3878301574586989762),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 3114879011783737325),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 2489888417172077595),
        name: 'key',
        type: 9,
        flags: 2048,
        indexId: const obx_int.IdUid(1, 2368769739506597955),
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 3878301574586989762),
        name: 'bytes',
        type: 23,
        flags: 0,
      ),
...
/// [CachedIcon] entity fields to define ObjectBox queries.
class CachedIcon_ {
  /// See [CachedIcon.id].
  static final id = obx.QueryIntegerProperty<CachedIcon>(
    _entities[0].properties[0],
  );

  /// See [CachedIcon.key].
  static final key = obx.QueryStringProperty<CachedIcon>(
    _entities[0].properties[1],
  );

  /// See [CachedIcon.bytes].
  static final bytes = obx.QueryByteVectorProperty<CachedIcon>(
